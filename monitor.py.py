...
funds_data_config = {
    ...
    # 🚀 已換成大哥提供的最新 10 檔精準成分股名單與權重
    "nomura_dividend": {
        "南電": ("8046.TW", 9.18), "華星光": ("4979.TWO", 5.10), "欣興": ("3037.TW", 8.94), 
        "聯發科": ("2454.TW", 3.96), "聯亞": ("3081.TWO", 7.45), "景碩": ("3189.TW", 3.79), 
        "台積電": ("2330.TW", 9.63), "臻鼎-KY": ("4958.TW", 3.65), "奇鋐": ("3017.TW", 6.05), "致茂": ("2360.TW", 3.59)
    },
    "nomura_twdpremium": {
...
def run_monitor():
    ...
    if os.path.exists("index.html"):
        ...
        with open("index.html", "w", encoding="utf-8") as f:
            f.write(content)
        print("【成功】野村台灣高股息基金數據已依照您提供的最新名單更新！")
